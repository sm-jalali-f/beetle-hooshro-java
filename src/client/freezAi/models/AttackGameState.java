...
public class AttackGameState {
    ...
    AttackGameState parentState;
    int SlipperId;
    int SlipperRemainTurn;
    double f;
    public AttackGameState(World game,Direction beetleDir,int beetlePosX,int beetlePosY,int beetlePower
...
//        System.out.println("GameState.calculate_manhatan_distance_with_food: foodList.size: "+foodList.size());
    ...
    public AttackGameState getParent(){
        return  this.parentState;
    }
    public void setParent(AttackGameState state) {
