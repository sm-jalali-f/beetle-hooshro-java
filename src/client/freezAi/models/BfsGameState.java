...
public class BfsGameState {
    ...
    BfsGameState parentState;
    int SlipperId;
    int SlipperRemainTurn;
    double f;
    public BfsGameState(World game,Direction beetleDir,int beetlePosX,int beetlePosY,int beetlePower
            ...
            ,BfsGameState parent,int slipperId,int slipperRemainTurn) {
        this.parentState = parent;
        this.SlipperId =slipperId;
        this.SlipperRemainTurn = slipperRemainTurn;
        this.game = game;
    ...
    public boolean isHelpfulState(){
        for (int i = 0; i < slipperList.size(); i++) {
            if(slipperList.get(i)!=null) {
                if (slipperList.get(i).getPosition().getX() == beetlePosX
                        && slipperList.get(i).getPosition().getY() == beetlePosY
                        && slipperAgeList.get(i) == 0) {
                    return false;
                }
            }
        }
...
//        System.out.println("GameState.calculate_manhatan_distance_with_food: foodList.size: "+foodList.size());
    ...
    public BfsGameState getParent(){
        return  this.parentState;
    }
    public void setParent(BfsGameState state) {
    ...
    public int getSlipperRemainTurn() {
        return SlipperRemainTurn;
    }

    public int getSlipperId() {
        return SlipperId;
    }
}
